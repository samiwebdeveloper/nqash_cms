...
message:"Delivery Express <br> System Developer M.Saim <br>Date:<?php echo ''.date('Y-m-d'); ?> <br>  <br>LoadSheet Lists<br>"
}
]       
});
 });
...
<div class="col-md-12">
  <div class="card m-t-10">
    ...
    <div class="card-title">
      ...
      <a href="<?php echo base_url(); ?>Arrival/create_arrival_sheet_view" class='btn btn-primary'>Create Load Sheet</a>
