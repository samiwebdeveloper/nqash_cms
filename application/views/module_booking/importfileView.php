...
<div class="card-body">
<h3 class="text-danger no-margin">Import Status</h3>
<br>
<p>Download CSV File.
  <br>
  Insert Data.
...
<div class="card-body">
<p class="sm-p-t-20">You can also make multiple statuses by uplaoding csv file.  <a href="<?php echo base_url();?>assets/import_booking.csv">Click here for download csv format.</a> 
</p>
<div class="row">
