...
<body onload="window.print()">
    ...
    <table style="width:100%;border-bottom:1px solid black">
        <td style="width:17%;border-right:1px solid black"><center><img src="https://tmdelex.com/cargo/assets/img/print_logo.png" width="172" height="85"></center></td>
        <td style="width:60%">
        ...
        <td style="width:17%;border-left:1px solid black"><center><img src="https://tmdelex.com/cargo/assets/barcode/cn/<?php echo $rows->order_code; ?>.png"  width="155" height="61"></center></td>
    </table> 
       <table style="width:100%">
        ...
        <td style="width:21.5%"><center><img src="https://tmdelex.com/cargo/assets/tmcargoqr.png"  width="80" height="80"></center></td>
        </tr>
        </table>  
        ...
        <table style="width:100%">
        <th style="width:100%;border-top:1px solid black"><center>Shopseven86.com (Best Quality Guranteed)</center></th>
        </table>  
        <?php } ?>
        <table style="width:100%">
        <th style="width:100%;border-top:1px solid black"><center>The Consignment is booked on shipper risk Please don't accept if shippment is not intact. </center></th>
        </table>  
    </div>
 </center>
<hr>
