...
<div class="row">
 ...
 <a href="<?php echo base_url();?>assets/Import_booking.csv"><img src='<?php echo base_url();?>assets/import_booking.PNG' class='img img-responsive' ></a> 
                        ...
                        <thead>
                        <tr style="background-image:linear-gradient(45deg, #1f3953, #795548);">
                        <th style="color:white">Shipment Type</th>
                        <th style="color:white">Type Name</th>
                        </tr>
                        </thead>   
                        ...
                        <div class="table-responsive">
                        <h3>Pick Up Point</h3> 
                        <table class='table table-bordered' id="pickupTable" style="background-image:linear-gradient(45deg, #1f3953, #795548);">
                        <thead>
                        <tr>
                        <th style="color:white">Pickup Point ID</th>
                        <th style="color:white">Pickup Point</th>
                        </tr>
                        </thead>   
                        <tbody id="resultTable">
                        ...
                        echo("<td><center>".$point->point.", ".$point->city_name.", ".$point->country_name."</center></td>");
                        echo("</tr>"); 
                        }}?>
                        </tbody>  
                        </table>
                        ...
                        <div class="table-responsive">
                        <h3>Destination</h3> 
                        <table class='table table-bordered' id="destinationTable" style="background-image:linear-gradient(45deg, #1f3953, #795548);">
                        <thead>
                        <tr>
                        
                        <th style="color:white">Desitnation City Code</th>
                        </tr>
                        </thead>   
                        <tbody id="resultTable">
