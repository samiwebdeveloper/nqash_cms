...
<body onload="window.print()">
    ...
    foreach($print_data as $rows){ $i=2; ?>
    <hr>
    <center>
    ...
    <table style="width:100%;border-bottom:1px solid black">
        ...
        <tr>
         ...
         <tr>
            <th>&nbsp;Shipper</th>
             <td><?php $name=substr($rows->customer_reference_no, 0, 5);
            if($name!="#SAIM" && $name!="#786@"){
            echo $result = $rows->customer_name; 
            } else if($name=="#SAIM") {
            echo $result = "Shopping Asaan"; 
            } else if($name=="#786@") {
            echo $result = "Shopseven86"; 
            }
            ?></td>
       ...
       <table style="width:100%">
        ...
        <table style="width:100%">
        <td style="width:100%;border-top:1px solid black"><center><b>Product Details</b>: <?php echo $rows->product_detail; ?></center></td>
        </table>  
        <table style="width:100%;border-top:1px solid black">
        <td style="width:100%;border-top:1px solid black"><center><b>Remarks :</b> &nbsp;<?php echo $rows->order_remark; ?></center></td>
        </table> 
        ...
        <?php } ?>
        <?php if($_SESSION['customer_id']=='576' || $name=="#786@"){ ?>
        <table style="width:100%">
