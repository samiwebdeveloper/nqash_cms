              ...
              <div class="inner">
                <!-- START BREADCRUMB -->
                 <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Manifest Pendings</li>
...
<div class="table-responsive m-t-10">
 <table class="table table-bordered" id="myTable">
  ...
  <?php 
  $i=0;
  if(!empty($pending_manifest_data)){
  foreach($pending_manifest_data as $rows){ 
  $i=$i+1;  
  echo("<tr>");
  echo("<td>".$i."</td>");
  echo("<td>".$rows->manifest."</td>");
  echo("<td>".$rows->City."</td>");
  echo("<td>".$rows->date."</td>");
  echo("<td>".$rows->Total_CN."</td>");
  echo("</tr>");  
  }} ?>
  </tbody> 
 </table> 
