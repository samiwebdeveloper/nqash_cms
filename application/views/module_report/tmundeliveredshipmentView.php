...
pageSize: 'A4',
footer: 'true',
title:"TM UN Delivered Shipments Report",
text:"<i class='fs-14 pg-download'></i> PDF",
titleAttr: 'PDF',
message:"Delivery Express\n  Powered By SaimTech \n Date:<?php echo ''.$start_date." - ".$end_date; ?> \n TM UN Delivered Shipments Report \n "
},
{
extend: 'excelHtml5',
text:"<i class='fs-14 pg-form'></i> Excel",
titleAttr: 'Excel',
sheetName:'TM UN Delivered Shipments Report<?php echo ''.$start_date." - ".$end_date; ?>',
exportOptions: {
...
titleAttr: 'Print',
footer: 'true',
title:"UN Delivered Report",
message:"Delivery Express <br> System Developer M.Saim <br>Date:<?php echo ''.$start_date." - ".$end_date; ?> <br>  <br>TM UN Delivered Shipments Report<br>"
}
]       
});
...
<form role="form" method="post" action="<?php echo base_url(); ?>Tm/submit_tm_undeliverd">
