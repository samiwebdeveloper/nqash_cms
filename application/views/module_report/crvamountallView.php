...
<form role="form" method="post" action="<?php echo base_url(); ?>Archive/crv_report_submit_all">
...
<div class="table-responsive m-t-10">
 <table class="table table-bordered" id="mmyTable">
  ...
  if($rows->is_crv==0){
  echo("<td class='text-black'><center><code>Not Received</code></center></td>");   
  } else {
  ...
  echo("<td class='bg-info text-white' style='font-size:15px'><center>".number_format($rows->amount)."</center></td>");
    if($rows->is_crv==0){
 echo("<td><center><code>Not Received</code></center></td>");   
    } else {
  echo("<td><center>Received</center></td>");}
  echo("</tr>");      
  }
