...
titleAttr: 'Excel',
sheetName:'TM Shipments Report<?php echo ''.$start_date." - ".$end_date; ?>',
exportOptions: {
...
footer: 'true',
title:"DCR Report",
message:"Delivery Express <br> System Developer M.Saim <br>Date:<?php echo ''.$start_date." - ".$end_date; ?> <br>  <br>TM Shipments Report<br>"
}
]       
});
...
<form role="form" method="post" action="<?php echo base_url(); ?>Tm/submit_tm">
