...
titleAttr: 'Excel',
sheetName:'CRV Report <?php echo ''.$start_date." - ".$end_date; ?>',
exportOptions: {
...
footer: 'true',
title:"CRV Report",
message:"Delivery Express <br> System Developer M.Saim <br>Date:<?php echo ''.$start_date." - ".$end_date; ?> <br>  <br>CRV Report<br>"
}
]       
});
...
<form role="form" method="post" action="<?php echo base_url(); ?>Archive/all_crv_submit_report">
