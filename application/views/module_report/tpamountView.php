...
titleAttr: 'Excel',
sheetName:'TPA Report <?php echo ''.$start_date." - ".$end_date; ?>',
exportOptions: {
...
footer: 'true',
title:"DCR Report",
message:"Delivery Express <br> System Developer M.Saim <br>Date:<?php echo ''.$start_date." - ".$end_date; ?> <br>  <br>TPA Report<br>"
}
]       
});
              ...
              <div class="inner">
                <!-- START BREADCRUMB -->
                 <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">TPA Amount Data</li>
...
<form role="form" method="post" action="<?php echo base_url(); ?>Report/m_pending_amount_submit">
