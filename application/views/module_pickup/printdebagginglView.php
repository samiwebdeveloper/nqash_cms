...
<body onload="window.print()">
 <img src="<?php echo base_url(); ?>assets/img/logo.png" width="172" height="85"><img src="<?php echo base_url(); ?>assets/barcode/bagging/<?php echo $sheet_code; ?>.png" width="182" height="80" style="margin-left: 80%"><center><h1>Operations DE Bagging</h1></center>

 <h4 style="margin-left:55px;margin-top:20px">

 DE Bagging ID           : <?php echo $sheet_code; ?><br>
 DE Bagging Date & Time  : <?php echo $sheet_date; ?></h4>
<br>
