...
<div class="row">
              ...
              <div class="card-header  separator">
                      ...
                      <div class="card-body">
                       <div class='pull-right'><a href="<?php echo base_url(); ?>Home/branch_qsr"><button class='btn btn-primary'>New Portal Branch QSR</button></a></div>
...
<form role="form" action="<?php echo base_url();?>Home/submit_old_branch_qsr" method="post">
