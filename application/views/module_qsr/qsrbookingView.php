...
<form role="form" action="<?php echo base_url();?>Home/submit_booking_qsr" method="post">
...
<?php echo $msg; ?>
                        ...
                        <div class="table-responsive">
                          ...
                          <th>CN</th>
                          <th>Manual CN</th>
                          <th>Booking Pieces</th>
                          <th>Booking Weight</th>
                          <th>Arrival Pieces</th>
                         ...
                         <tbody id="resultTable">
                          ...
                          echo("<td>".$rows->pcs."</td>");
                          echo("<td>".$rows->wgt."</td>");
                          echo("<td>".$rows->Apieces."</td>");
                          echo("<td>".$rows->Aweight."</td>");
                          echo("</tr>"); 
                                }}?>
