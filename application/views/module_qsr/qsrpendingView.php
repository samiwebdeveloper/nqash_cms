...
<form role="form" action="<?php echo base_url();?>Home/submit_pending_qsr" method="post">
...
<?php echo $msg; ?>
                          ...
                          <div class="card card-default bg-primary" style="background-image:linear-gradient(to right, #16222A , #3A6073)">
                              <div class="card-header  separator">
                                <div class="card-title " style="color:white;">Shipment Summary
                                  </div>
                                </div>
                            <div class="card-body">
                                <div class="table-responsive">
  					            ...
  					            <tbody>
  					             <?php if(!empty($pending_summary_qsr_data)){
  					             $sum = 0;
  					             ?>
  					          
  					            <?php foreach($pending_summary_qsr_data as $rows){?>
