												...
												<tbody>
													...
													?>
														<tr>
															...
															<td><?php echo $i ?></td>
															<td class="text-center " style="cursor:pointer;" data-toggle="modal" data-target="#edit_<?php echo $ProjectImageId ?>"><img width="30px" height="30px" src="<?php echo base_url(); ?>assets/upload_image/<?php echo $Image ?>" alt="<?php echo $Alternative ?>"> </td>
