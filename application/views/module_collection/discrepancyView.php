            ...
            <div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
                <div class="inner">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><mark>Discrepancy Report</mark></li>
                    </ol>
                    <!-- END BREADCRUMB -->
                </div>
            </div>
                            ...
                            <div class="col-md-12">
                                <div class="card m-t-10">
                                    <div class="card-header  separator">
                                        <div class="card-title"><h3>Collection Discrepancies</h3>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive m-t-10">
                                            <table class="table table-bordered" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $i = 0;
                                                    if (!empty($discrepancy_collect)) {
                                                        foreach ($discrepancy_collect as $rows) {
                                                            $i = $i + 1;
                                                            echo ("<tr>");
                                                            echo ("<td>" . $i . "</td>");
                                                            ...
                                                            echo ("<td>" . $rows->cod_sheet_no . " | " . $rows->oper_user_name . "</td>");
                                                            echo ("<td> Rs.<b>" . $rows->Difference . "</b></td>");
                                                            echo ("</tr>");
                                                        }
                                                    } ?>
                                                </tbody>
