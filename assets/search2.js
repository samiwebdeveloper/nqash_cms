...
(function() {
  ...
  $.fn.saimtech = function(options) {
    ...
    return this.each(function() {
      ...
      settings = $.extend({
        searchInput: null,
        searchTemplate: "<div class='col-lg-6 col-md-6 col-sm-6 pull-left'><input type='text' style='background-color:#C0C0C0;border:1px solid #675282' class='form-control' placeholder='Find'><br></div>",
